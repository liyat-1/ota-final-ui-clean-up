...
function AddActions({
  ...
  const cls = `inline-flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-dashed bg-white font-semibold transition-colors ${
  ...
  return (
    <div className="mx-auto w-full max-w-md overflow-hidden rounded-xl border border-blue-200 bg-blue-50/50 ring-1 ring-blue-100">
      <div className="flex items-start gap-3 px-4 py-3.5">
        <span className="grid size-9 shrink-0 place-items-center rounded-xl bg-white text-blue-600 ring-1 ring-blue-200">
          <Split size={16} />
        </span>
        <div className="min-w-0">
