  ...
  return (
    <div className="fixed inset-0 z-[95] grid place-items-center bg-slate-900/45 p-3 backdrop-blur-sm sm:p-6">
      <div
        role="dialog"
        aria-label={title}
        className="flex max-h-[88vh] w-full max-w-[980px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl duration-150 animate-in fade-in zoom-in-95"
      >
        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              className={`group rounded-2xl border-2 bg-white p-1 text-left transition-colors ${
        ...
        {EMAIL_TEMPLATES.map((tpl) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              className={`overflow-hidden rounded-2xl border-2 bg-white text-left transition-colors ${
