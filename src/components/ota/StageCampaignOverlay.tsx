  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-slate-900/40 p-3 backdrop-blur-sm sm:p-6">
      <div
        ...
        className="flex h-[94vh] w-full max-w-[1500px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl duration-150 animate-in fade-in zoom-in-95"
      >
        {/* Chrome */}
            ...
            <div className="grid h-full grid-cols-1 overflow-hidden lg:grid-cols-[31rem_minmax(0,1fr)]">
              ...
              <div className="grid min-h-0 place-items-center overflow-y-auto p-6">
                <div className="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-10 text-center">
                  ...
                  <span className="mx-auto grid size-11 place-items-center rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 text-white">
              ...
              <div className="mx-auto w-full max-w-5xl">
                <JourneyCanvas
                  ...
                  handlers={{
                    onEdit: setEditId,
                    onPreview: (id) => {
                      setPreviewPanel("email");
                      setPreviewId(id);
                    },
                    onTemplate: setPickFor,
      ...
      {previewing ? (
        <div className="fixed inset-0 z-[86] grid place-items-center bg-slate-900/40 p-3 backdrop-blur-sm sm:p-5">
          <div
            ...
            className="flex h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl duration-150 animate-in fade-in zoom-in-95"
          >
            <header className="flex shrink-0 items-start justify-between gap-3 border-b border-slate-200 px-5 py-3.5">
              ...
              <div className="flex items-center gap-2">
                <PanelTabs panel={previewPanel} onChange={setPreviewPanel} />
                <button
                  type="button"
      ...
      {editing ? (
        <div className="fixed inset-0 z-[88] grid place-items-center bg-slate-900/40 p-3 backdrop-blur-sm sm:p-5">
          <div
            ...
            className="flex h-[92vh] w-full max-w-[1400px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl duration-150 animate-in fade-in zoom-in-95"
          >
