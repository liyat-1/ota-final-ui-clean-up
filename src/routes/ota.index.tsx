...
import { StageCard, TransitionRail } from "@/components/ota/JourneyPieces";
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-[24px] font-semibold tracking-tight text-slate-900">Guest journey</h1>
      ...
      <div>
        {STAGES.map((stage, i) => (
          <Fragment key={stage.id}>
            {i > 0 ? <TransitionRail stage={stage} /> : null}
            <StageCard
              stage={stage}
              period={period}
